...
namespace TeachingBACKEND.Migrations
{
    ...
    [Migration("20250716124704_AddOptionsOnQuizz")]
    partial class AddOptionsOnQuizz
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TeachingBACKEND.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovalStatus = 1,
                            City = "Tirana",
                            CreateAt = new DateTime(2025, 7, 16, 12, 47, 4, 529, DateTimeKind.Utc).AddTicks(8720),
                            DateOfBirth = new DateTime(1985, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@teachapp.com",
                            FirstName = "System",
                            IsEmailVerified = true,
                            LastName = "Administrator",
                            PasswordHash = "$2a$12$mhRUo9401kZa8NCSQ.3qT.2fMbfJL/zqJqf24r1tX9OeJ42vTJ6pO",
